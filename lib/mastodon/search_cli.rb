...
module Mastodon
  class SearchCLI < Thor
    ...
    def deploy
      ...
      progress = ProgressBar.create(total: nil, format: '%t%c/%u |%b%i| %e', autofinish: false)
      ...
      indices.each do |index|
        ...
        index.types.each do |type|
          type.adapter.default_scope.reorder(nil).find_in_batches(batch_size: 500) do |records|
